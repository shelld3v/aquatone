...
func ParseOptions() (Options, error) {
	...
	flag.IntVar(&opts.ScanTimeout, "scan-timeout", 3*1000, "Timeout in miliseconds for port scans")
	flag.IntVar(&opts.HTTPTimeout, "http-timeout", 15*1000, "Timeout in miliseconds for HTTP requests")
	flag.IntVar(&opts.ScreenshotTimeout, "screenshot-timeout", 40*1000, "Timeout in miliseconds for screenshots")
